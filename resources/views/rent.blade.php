        ...
        <div class="w-full md:w-4/5 bg-[#F1F4F3] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                @foreach ($helmen as $helm)
                    <div class="bg-[#cdcdcd] flex flex-col items-center p-3 product-item cursor-pointer"
                        data-name="{{ $helm->naam }}" data-price="{{ $helm->prijs }}"
                        data-image="{{ Vite::asset($helm->image_path) }}" data-description="{{ $helm->beschrijving }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                @foreach ($bellen as $bel)
                    <div class="bg-[#cdcdcd] flex flex-col items-center p-3 product-item cursor-pointer"
                        data-name="{{ $bel->naam }}" data-price="{{ $bel->prijs }}"
                        data-image="{{ Vite::asset($bel->image_path) }}" data-description="{{ $bel->beschrijving }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                @foreach ($snelbinders as $snelbinder)
                    <div class="bg-[#cdcdcd] flex flex-col items-center p-3 product-item cursor-pointer"
                        data-name="{{ $snelbinder->naam }}" data-price="{{ $snelbinder->prijs }}"
                        data-image="{{ Vite::asset($snelbinder->image_path) }}" data-description="{{ $snelbinder->beschrijving }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                @foreach ($verlichtingen as $licht)
                    <div class="bg-[#cdcdcd] flex flex-col items-center p-3 product-item cursor-pointer"
                        data-name="{{ $licht->naam }}" data-price="{{ $licht->prijs }}"
                        data-image="{{ Vite::asset($licht->image_path) }}" data-description="{{ $licht->beschrijving }}">
